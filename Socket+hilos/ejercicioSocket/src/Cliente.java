...
public class Cliente {
    ...
    public static void main(String[] args) {
        ...
        // Pedir nombre de usuario antes de conectarse
        System.out.print("Ingresá tu nombre de usuario: ");
        String nombreUsuario = teclado.nextLine().trim();

        System.out.println("=== CLIENTE [" + nombreUsuario + "] - Playlist de Música ===");
        ...
        try {
            ...
            while (activo) {
                ...
                // El comando VER devuelve múltiples líneas
            ...
            System.out.println("\nCerrando cliente. ¡Hasta luego, " + nombreUsuario + "!");
            sc.close();
